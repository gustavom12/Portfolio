...
function Navbar({
  ...
  const previusNavTitle = useChangeTitle(["Home","About","Skills","Experience"], inSpanish)
  ...
  return (
    <nav ref={navbarRef} className="d-flex justify-content-between w-100">
      <div>
        <h2 ref={titleRef} className="text-serif2 m-0 fw-bold">{navTitle}</h2>
      </div>
      <div className="d-flex">
        <div className="language my-auto fs-5 cursor-pointer"
          onClick={()=>{
        ...
        </div>
        {
          theme === "dark" ?
            ...
            ></i>
          :
            <i className="fas fa-sun cursor-pointer theme fs-2"
